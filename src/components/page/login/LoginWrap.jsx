...
function LoginWrap() {
	...
	// 	await api.auth.login({ email, password }).then((response) => {
	// 		localStorage.setItem('user', JSON.stringify(response.user))
	// 		sessionStorage.setItem('user', JSON.stringify(response.user))
	// 		console.log(localStorage.getItem('user'))
	// 		console.log(sessionStorage.getItem('user'))
	// 		localStorage.setItem('userToken', Cookies.get('userToken'))
	// 		sessionStorage.setItem('user', Cookies.get('userToken'))
	// 		setEmail('')
	// 		setPassword('')
	// 		// setValidated(true)
		...
		try {
			await axios
				...
				.then((response) => {
					...
					// localStorage.setItem('userToken', Cookies.get('userToken'))
					// sessionStorage.setItem('user', response['headers'])
