                    ...
                    <table className="eg-table order-table table mb-0">
                        ...
                        <tr>
                            <td data-label="Image">
                                <img
                                    alt="dashbordImage"
                                    src={process.env.PUBLIC_URL + '/images/bg/order1.png'}
                                    className="img-fluid"
                                />
                            </td>
                        ...
                        <tr>
                            <td data-label="Image">
                                <img
                                    alt="dashbordImage"
                                    src={process.env.PUBLIC_URL + '/images/bg/order2.png'}
                                    className="img-fluid"
                                />
                            </td>
                            <td data-label="Bidding ID">Bidding_HvO253gT</td>
                        ...
                        <tr>
                            <td data-label="Image">
                                <img
                                    alt="dashbordImage"
                                    src={process.env.PUBLIC_URL + '/images/bg/order3.png'}
                                    className="img-fluid"
                                />
                            </td>
                            <td data-label="Bidding ID">Bidding_HvO253gT</td>
                        ...
                        <tr>
                            <td data-label="Image">
                                <img
                                    alt="dashbordImage"
                                    src={process.env.PUBLIC_URL + '/images/bg/order4.png'}
                                    className="img-fluid"
                                />
                            </td>
                            <td data-label="Bidding ID">Bidding_HvO253gT</td>
                        ...
                        <tr>
                            <td data-label="Image">
                                <img
                                    alt="dashbordImage"
                                    src={process.env.PUBLIC_URL + '/images/bg/order5.png'}
                                />
                            </td>
                            <td data-label="Bidding ID">Bidding_HvO253gT</td>
                            <td data-label="Bid Amount(USD)">1222.8955</td>
