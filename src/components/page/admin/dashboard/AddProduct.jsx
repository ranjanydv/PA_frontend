...
const AddProduct = () => {
    ...
    return (
        <>
            ...
            <div className="tab-pane fade" id="v-pills-add-product" role="tabpanel" aria-labelledby="v-pills-add-product-tabs">
                <div className="dashboard-profile">
                    ...
                    <div className="form-wrapper">
                        <form action="#" style={{fontFamily: 'Saira'}}
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-6 col-lg-12 col-md-6">
                                    <div className="form-inner">
                                        ...
                                        >
                                            <option className={"selectBtn"} value="traditional">Traditional</option>
                                            <option className={"select-option"} value="cultural">Cultural</option>
                                ...
                                <div className="col-12">
                                    <div className="col-xl-6 col-lg-12 col-md-6">
                                        <div className="form-inner ">
                                            ...
                                            <h5 style={{display: 'inline', color: '#327c7d'}}>{user.name}</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-12">
                                    <div className="button-group">
                                        ...
                                        <button className="eg-btn cancel-btn" type='button'
                                ...
                                {showLink && (
                                    <div className="col-12 mt-4 mb-0">
                                        <div style={{display: 'flex', gap: '5px'}}>
                                            <p>Product <span className={'text-green'}>{prodId.name}</span> Added:</p>
                                            <Link className={'text-green mx-2'}
                                                  style={{color: '#327c7d', textDecoration: 'underline'}}
                                                  to={`${url.home}auction-details/${prodId._id}`}>View Product</Link>
                                        </div>
                                    </div>
                                )}
                            </div>
