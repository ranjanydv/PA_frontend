						...
						<div className="col-xl-7 col-lg-7 px-0">
							<div className="banner3-content">
								<span
									...
									data-wow-delay="0.5s"
								>
									Welcome To Premiere Auctioneers
								</span>
								<h1
									className="wow fadeInDown"
									data-wow-duration="1.5s"
								...
								<p
									...
									data-wow-delay="1s"
								>
									Welcome to Premiere Auctioneers and explore on the Nepal's
									best &amp; greatest Bidding marketplace with our beautiful
									Bidding products. We want to be a part of your smile, success
									and future growth. We contribute to Nepalese society by
									listing out artists from rural areas to have their crafts be
									visible to the whole country &hearts;.
								</p>
								<Link
									to={`/products`}
									onClick={() =>
